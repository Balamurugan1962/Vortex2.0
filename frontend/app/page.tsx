  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground">
      <div className="space-y-6 text-center animate-in fade-in zoom-in duration-700">
        <div className="mx-auto w-20 h-20 bg-primary rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(139,92,246,0.2)]">
          <ShieldCheck className="w-10 h-10 text-primary-foreground" />
        </div>
        <div className="space-y-2">
          <h1 className="text-4xl font-bold tracking-tight text-foreground">VortexExam</h1>
